...
import OneNewsSection from "../components/OneNewsSection/OneNewsSection";
  ...
  return (
    <div>
      ...
      <OneNewsSection>
        ...
        <CommentItem authorName={users[0].username} avatarUrl={null} date={news[0].date} text={news[0].text} />
      </OneNewsSection>
      <Footer />
    </div>
  );
